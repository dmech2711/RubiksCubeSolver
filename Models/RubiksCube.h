...
#ifndef RUBIKSCUBE3BY3_RUBIKSCUBE_H
#define RUBIKSCUBE3BY3_RUBIKSCUBE_H
...
public:
    ...
    static int getColorInt(char ch);

    static string getSide(int idx);

    virtual bool isValid() const =0;
    static MOVE getInvMove(int idx);
...
#endif //RUBIKSCUBE3BY3_RUBIKSCUBE_H
