...
// CornerDBMaker Testing --------------------------------------------------------------------------
    string fileName = "C:\\Users\\dhrum\\CLionProjects\\RubiksCube3by3\\Databases\\cornerDepth5V1.txt";

   // Code to create Corner Database
    // CornerDBMaker dbMaker(fileName, 0x99);
    // dbMaker.bfsAndStore();

    //====================================Shuffle for checking and testing===========//
 // RubiksCubeBitboard cube;//max solved is 12
 // RubiksCube3dArray cube;//max solved is 14
 // RubiksCube1dArray cube;//max solved is 6-7
 // cube.print();
 ...
 // cout<<"\n";
    ...
    // cout << "Time: " << chrono::duration<double>(en - st).count()<< " sec\n";

    //========================================INPUT TYPE===============================//
    RubiksCube3dArray cube;
    cube.readCube();
   if (!cube.isValid()) {
       cout<<"Given Cube is invalid!!!";
       return 0;
   }
    cube.print();
